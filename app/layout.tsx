...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: "ImageStudioLab - Create Aesthetic Video Polaroids",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "ImageStudioLab Aesthetic Creator Preview",
      },
    ],
  },
  twitter: {
    card: "summary_large_image",
    title: "ImageStudioLab - AI Video & Photo Creator",
    description: "Create viral aesthetic content with ImageStudioLab. Video support, AI edits, and cinematic vibes.",
    images: ["/og-image.jpg"],
    creator: "@imagestudiolab",
  },
  robots: {
